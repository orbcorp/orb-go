...
type InvoiceDiscount struct {
	DiscountType InvoiceDiscountDiscountType `json:"discount_type,required"`
	...
	JSON                    invoiceDiscountJSON `json:"-"`
	union                   InvoiceDiscountUnion
}

// invoiceDiscountJSON contains the JSON metadata for the struct [InvoiceDiscount]
type invoiceDiscountJSON struct {
...
func (r invoiceDiscountJSON) RawJSON() string {
	return r.raw
}
...
// AsUnion returns a [InvoiceDiscountUnion] interface which you can cast to the
// specific types for more type safety.
//
// Possible runtime types of the union are [InvoiceDiscountPercentageDiscount],
// [InvoiceDiscountAmountDiscount], [InvoiceDiscountTrialDiscount].
...
// [InvoiceDiscountAmountDiscount] or [InvoiceDiscountTrialDiscount].
...
func init() {
	apijson.RegisterUnion(
		reflect.TypeOf((*InvoiceDiscountUnion)(nil)).Elem(),
		"discount_type",
		apijson.UnionVariant{
			TypeFilter:         gjson.JSON,
			Type:               reflect.TypeOf(InvoiceDiscountPercentageDiscount{}),
			DiscriminatorValue: "percentage",
		},
		apijson.UnionVariant{
			TypeFilter:         gjson.JSON,
			Type:               reflect.TypeOf(InvoiceDiscountAmountDiscount{}),
			DiscriminatorValue: "amount",
		},
		apijson.UnionVariant{
			TypeFilter:         gjson.JSON,
			Type:               reflect.TypeOf(InvoiceDiscountTrialDiscount{}),
...
type InvoiceDiscountPercentageDiscount struct {
	...
	Reason             string                                `json:"reason,nullable"`
	JSON               invoiceDiscountPercentageDiscountJSON `json:"-"`
}
...
func (r invoiceDiscountPercentageDiscountJSON) RawJSON() string {
	return r.raw
}
...
func (r InvoiceDiscountPercentageDiscountDiscountType) IsKnown() bool {
	switch r {
	case InvoiceDiscountPercentageDiscountDiscountTypePercentage:
		return true
	}
	return false
}
...
type InvoiceDiscountAmountDiscount struct {
	...
	Reason            string                                    `json:"reason,nullable"`
	JSON              invoiceDiscountAmountDiscountJSON         `json:"-"`
}
...
func (r invoiceDiscountAmountDiscountJSON) RawJSON() string {
	return r.raw
}
...
func (r InvoiceDiscountAmountDiscountDiscountType) IsKnown() bool {
	switch r {
	case InvoiceDiscountAmountDiscountDiscountTypeAmount:
		return true
	}
	return false
}
...
type InvoiceDiscountTrialDiscount struct {
	...
	// Only available if discount_type is `trial`
	TrialPercentageDiscount float64                          `json:"trial_percentage_discount,nullable"`
	JSON                    invoiceDiscountTrialDiscountJSON `json:"-"`
}
...
func (r invoiceDiscountTrialDiscountJSON) RawJSON() string {
	return r.raw
}
...
func (r InvoiceDiscountTrialDiscountDiscountType) IsKnown() bool {
	switch r {
	case InvoiceDiscountTrialDiscountDiscountTypeTrial:
		return true
	}
	return false
}
...
const (
	...
	InvoiceDiscountDiscountTypeAmount     InvoiceDiscountDiscountType = "amount"
	InvoiceDiscountDiscountTypeTrial      InvoiceDiscountDiscountType = "trial"
)

func (r InvoiceDiscountDiscountType) IsKnown() bool {
	switch r {
	case InvoiceDiscountDiscountTypePercentage, InvoiceDiscountDiscountTypeAmount, InvoiceDiscountDiscountTypeTrial:
		return true
	}
	return false
}
...
type InvoiceFetchUpcomingResponse struct {
	...
	// provided, the first discount in the list will be returned. If the list is empty,
	// `None` will be returned.
	Discount  InvoiceFetchUpcomingResponseDiscount   `json:"discount,required,nullable"`
	Discounts []InvoiceFetchUpcomingResponseDiscount `json:"discounts,required"`
	// When the invoice payment is due.
	DueDate time.Time `json:"due_date,required" format:"date-time"`
	// If the invoice has a status of `draft`, this will be the time that the invoice
	// will be eligible to be issued, otherwise it will be `null`. If `auto-issue` is
...
// provided, the first discount in the list will be returned. If the list is empty,
// `None` will be returned.
type InvoiceFetchUpcomingResponseDiscount struct {
	DiscountType InvoiceFetchUpcomingResponseDiscountDiscountType `json:"discount_type,required"`
	// This field can have the runtime type of [[]string].
	AppliesToPriceIDs interface{} `json:"applies_to_price_ids"`
	Reason            string      `json:"reason,nullable"`
	// Only available if discount_type is `percentage`. This is a number between 0
	...
	// Only available if discount_type is `trial`
	TrialPercentageDiscount float64                                  `json:"trial_percentage_discount,nullable"`
	JSON                    invoiceFetchUpcomingResponseDiscountJSON `json:"-"`
	union                   InvoiceFetchUpcomingResponseDiscountUnion
}

// invoiceFetchUpcomingResponseDiscountJSON contains the JSON metadata for the
// struct [InvoiceFetchUpcomingResponseDiscount]
type invoiceFetchUpcomingResponseDiscountJSON struct {
	DiscountType            apijson.Field
	AppliesToPriceIDs       apijson.Field
	Reason                  apijson.Field
	PercentageDiscount      apijson.Field
...
func (r invoiceFetchUpcomingResponseDiscountJSON) RawJSON() string {
	return r.raw
}

func (r *InvoiceFetchUpcomingResponseDiscount) UnmarshalJSON(data []byte) (err error) {
	*r = InvoiceFetchUpcomingResponseDiscount{}
	err = apijson.UnmarshalRoot(data, &r.union)
	if err != nil {
		return err
	}
...
// AsUnion returns a [InvoiceFetchUpcomingResponseDiscountUnion] interface which
// you can cast to the specific types for more type safety.
//
// Possible runtime types of the union are
// [InvoiceFetchUpcomingResponseDiscountPercentageDiscount],
// [InvoiceFetchUpcomingResponseDiscountAmountDiscount],
// [InvoiceFetchUpcomingResponseDiscountTrialDiscount].
...
// `None` will be returned.
//
// Union satisfied by [InvoiceFetchUpcomingResponseDiscountPercentageDiscount],
// [InvoiceFetchUpcomingResponseDiscountAmountDiscount] or
// [InvoiceFetchUpcomingResponseDiscountTrialDiscount].
type InvoiceFetchUpcomingResponseDiscountUnion interface {
	implementsInvoiceFetchUpcomingResponseDiscount()
}

func init() {
	apijson.RegisterUnion(
		reflect.TypeOf((*InvoiceFetchUpcomingResponseDiscountUnion)(nil)).Elem(),
		"discount_type",
		apijson.UnionVariant{
			TypeFilter:         gjson.JSON,
			Type:               reflect.TypeOf(InvoiceFetchUpcomingResponseDiscountPercentageDiscount{}),
			DiscriminatorValue: "percentage",
		},
		apijson.UnionVariant{
			TypeFilter:         gjson.JSON,
			Type:               reflect.TypeOf(InvoiceFetchUpcomingResponseDiscountAmountDiscount{}),
			DiscriminatorValue: "amount",
		},
		apijson.UnionVariant{
			TypeFilter:         gjson.JSON,
			Type:               reflect.TypeOf(InvoiceFetchUpcomingResponseDiscountTrialDiscount{}),
			DiscriminatorValue: "trial",
		},
	)
}

type InvoiceFetchUpcomingResponseDiscountPercentageDiscount struct {
	// List of price_ids that this discount applies to. For plan/plan phase discounts,
	// this can be a subset of prices.
	AppliesToPriceIDs []string                                                           `json:"applies_to_price_ids,required"`
	DiscountType      InvoiceFetchUpcomingResponseDiscountPercentageDiscountDiscountType `json:"discount_type,required"`
	// Only available if discount_type is `percentage`. This is a number between 0
	// and 1.
	PercentageDiscount float64                                                    `json:"percentage_discount,required"`
	Reason             string                                                     `json:"reason,nullable"`
	JSON               invoiceFetchUpcomingResponseDiscountPercentageDiscountJSON `json:"-"`
}

// invoiceFetchUpcomingResponseDiscountPercentageDiscountJSON contains the JSON
// metadata for the struct [InvoiceFetchUpcomingResponseDiscountPercentageDiscount]
type invoiceFetchUpcomingResponseDiscountPercentageDiscountJSON struct {
	AppliesToPriceIDs  apijson.Field
	DiscountType       apijson.Field
	PercentageDiscount apijson.Field
	Reason             apijson.Field
...
func (r invoiceFetchUpcomingResponseDiscountPercentageDiscountJSON) RawJSON() string {
	return r.raw
}

func (r InvoiceFetchUpcomingResponseDiscountPercentageDiscount) implementsInvoiceFetchUpcomingResponseDiscount() {
}
...
func (r InvoiceFetchUpcomingResponseDiscountPercentageDiscountDiscountType) IsKnown() bool {
	switch r {
	case InvoiceFetchUpcomingResponseDiscountPercentageDiscountDiscountTypePercentage:
		return true
	}
	return false
}

type InvoiceFetchUpcomingResponseDiscountAmountDiscount struct {
	// Only available if discount_type is `amount`.
	AmountDiscount string `json:"amount_discount,required"`
	// List of price_ids that this discount applies to. For plan/plan phase discounts,
	// this can be a subset of prices.
	AppliesToPriceIDs []string                                                       `json:"applies_to_price_ids,required"`
	DiscountType      InvoiceFetchUpcomingResponseDiscountAmountDiscountDiscountType `json:"discount_type,required"`
	Reason            string                                                         `json:"reason,nullable"`
	JSON              invoiceFetchUpcomingResponseDiscountAmountDiscountJSON         `json:"-"`
}

// invoiceFetchUpcomingResponseDiscountAmountDiscountJSON contains the JSON
// metadata for the struct [InvoiceFetchUpcomingResponseDiscountAmountDiscount]
type invoiceFetchUpcomingResponseDiscountAmountDiscountJSON struct {
	AmountDiscount    apijson.Field
	AppliesToPriceIDs apijson.Field
	DiscountType      apijson.Field
	Reason            apijson.Field
...
func (r invoiceFetchUpcomingResponseDiscountAmountDiscountJSON) RawJSON() string {
	return r.raw
}

func (r InvoiceFetchUpcomingResponseDiscountAmountDiscount) implementsInvoiceFetchUpcomingResponseDiscount() {
}
...
func (r InvoiceFetchUpcomingResponseDiscountAmountDiscountDiscountType) IsKnown() bool {
	switch r {
	case InvoiceFetchUpcomingResponseDiscountAmountDiscountDiscountTypeAmount:
		return true
	}
	return false
}

type InvoiceFetchUpcomingResponseDiscountTrialDiscount struct {
	// List of price_ids that this discount applies to. For plan/plan phase discounts,
	// this can be a subset of prices.
	AppliesToPriceIDs []string                                                      `json:"applies_to_price_ids,required"`
	DiscountType      InvoiceFetchUpcomingResponseDiscountTrialDiscountDiscountType `json:"discount_type,required"`
	Reason            string                                                        `json:"reason,nullable"`
	// Only available if discount_type is `trial`
	TrialAmountDiscount string `json:"trial_amount_discount,nullable"`
	// Only available if discount_type is `trial`
	TrialPercentageDiscount float64                                               `json:"trial_percentage_discount,nullable"`
	JSON                    invoiceFetchUpcomingResponseDiscountTrialDiscountJSON `json:"-"`
}

// invoiceFetchUpcomingResponseDiscountTrialDiscountJSON contains the JSON metadata
// for the struct [InvoiceFetchUpcomingResponseDiscountTrialDiscount]
type invoiceFetchUpcomingResponseDiscountTrialDiscountJSON struct {
	AppliesToPriceIDs       apijson.Field
	DiscountType            apijson.Field
	Reason                  apijson.Field
	TrialAmountDiscount     apijson.Field
...
func (r invoiceFetchUpcomingResponseDiscountTrialDiscountJSON) RawJSON() string {
	return r.raw
}

func (r InvoiceFetchUpcomingResponseDiscountTrialDiscount) implementsInvoiceFetchUpcomingResponseDiscount() {
}
...
func (r InvoiceFetchUpcomingResponseDiscountTrialDiscountDiscountType) IsKnown() bool {
	switch r {
	case InvoiceFetchUpcomingResponseDiscountTrialDiscountDiscountTypeTrial:
		return true
	}
	return false
}
...
const (
	InvoiceFetchUpcomingResponseDiscountDiscountTypePercentage InvoiceFetchUpcomingResponseDiscountDiscountType = "percentage"
	InvoiceFetchUpcomingResponseDiscountDiscountTypeAmount     InvoiceFetchUpcomingResponseDiscountDiscountType = "amount"
...
func (r InvoiceFetchUpcomingResponseDiscountDiscountType) IsKnown() bool {
	switch r {
	case InvoiceFetchUpcomingResponseDiscountDiscountTypePercentage, InvoiceFetchUpcomingResponseDiscountDiscountTypeAmount, InvoiceFetchUpcomingResponseDiscountDiscountTypeTrial:
		return true
	}
	return false
}
