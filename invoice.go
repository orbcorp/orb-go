...
type Invoice struct {
	...
	Plan InvoicePlan `json:"plan,required,nullable"`
...
type InvoicePlan struct {
	...
	JSON           invoicePlanJSON `json:"-"`
}

// invoicePlanJSON contains the JSON metadata for the struct [InvoicePlan]
type invoicePlanJSON struct {
	ID             apijson.Field
...
func (r *InvoicePlan) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}
...
type InvoiceFetchUpcomingResponse struct {
	...
	// The active plan for this invoice's subscription on its invoice date. This field
	// is only populated for invoices generated by subscriptions.
	Plan InvoiceFetchUpcomingResponsePlan `json:"plan,required,nullable"`
	// If the invoice is in draft, this timestamp will reflect when the invoice is
	// scheduled to be issued.
	ScheduledIssueAt time.Time                                   `json:"scheduled_issue_at,required,nullable" format:"date-time"`
...
// The active plan for this invoice's subscription on its invoice date. This field
// is only populated for invoices generated by subscriptions.
type InvoiceFetchUpcomingResponsePlan struct {
	ID string `json:"id,required,nullable"`
	// An optional user-defined ID for this plan resource, used throughout the system
	// as an alias for this Plan. Use this field to identify a plan by an existing
	// identifier in your system.
	ExternalPlanID string                               `json:"external_plan_id,required,nullable"`
	Name           string                               `json:"name,required,nullable"`
	JSON           invoiceFetchUpcomingResponsePlanJSON `json:"-"`
}

// invoiceFetchUpcomingResponsePlanJSON contains the JSON metadata for the struct
// [InvoiceFetchUpcomingResponsePlan]
type invoiceFetchUpcomingResponsePlanJSON struct {
	ID             apijson.Field
	ExternalPlanID apijson.Field
	Name           apijson.Field
	raw            string
...
func (r *InvoiceFetchUpcomingResponsePlan) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}
