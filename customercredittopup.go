...
// topUpInvoiceSettingsJSON contains the JSON metadata for the struct
// [TopUpInvoiceSettings]
type topUpInvoiceSettingsJSON struct {
...
func (r topUpInvoiceSettingsJSON) RawJSON() string {
	return r.raw
}
...
type CustomerCreditTopUpNewResponse struct {
	...
	InvoiceSettings TopUpInvoiceSettings `json:"invoice_settings" api:"required"`
	// How much, in the customer's currency, to charge for each unit.
	PerUnitCostBasis string `json:"per_unit_cost_basis" api:"required"`
	...
	// does not expire.
	ExpiresAfter int64 `json:"expires_after" api:"nullable"`
	// The unit of expires_after.
	ExpiresAfterUnit CustomerCreditTopUpNewResponseExpiresAfterUnit `json:"expires_after_unit" api:"nullable"`
...
type CustomerCreditTopUpListResponse struct {
	...
	ExpiresAfter int64 `json:"expires_after" api:"nullable"`
	// The unit of expires_after.
	ExpiresAfterUnit CustomerCreditTopUpListResponseExpiresAfterUnit `json:"expires_after_unit" api:"nullable"`
...
type CustomerCreditTopUpNewByExternalIDResponse struct {
	...
	ExpiresAfter int64 `json:"expires_after" api:"nullable"`
	// The unit of expires_after.
	ExpiresAfterUnit CustomerCreditTopUpNewByExternalIDResponseExpiresAfterUnit `json:"expires_after_unit" api:"nullable"`
...
type CustomerCreditTopUpListByExternalIDResponse struct {
	...
	ExpiresAfter int64 `json:"expires_after" api:"nullable"`
	// The unit of expires_after.
	ExpiresAfterUnit CustomerCreditTopUpListByExternalIDResponseExpiresAfterUnit `json:"expires_after_unit" api:"nullable"`
...
type CustomerCreditTopUpNewParams struct {
	...
	// Settings for invoices generated by triggered top-ups.
	InvoiceSettings param.Field[CustomerCreditTopUpNewParamsInvoiceSettings] `json:"invoice_settings" api:"required"`
	// How much, in the customer's currency, to charge for each unit.
	PerUnitCostBasis param.Field[string] `json:"per_unit_cost_basis" api:"required"`
	// The threshold at which to trigger the top-up. If the balance is at or below this
	// threshold, the top-up will be triggered.
...
type CustomerCreditTopUpNewParamsInvoiceSettings struct {
	...
	// date for the invoice. If you intend the invoice to be due on issue, set this
	// to 0.
	NetTerms param.Field[int64] `json:"net_terms" api:"required"`
	// An optional memo to display on the invoice.
...
type CustomerCreditTopUpNewByExternalIDParams struct {
	...
	Currency param.Field[string] `json:"currency" api:"required"`
	// Settings for invoices generated by triggered top-ups.
	InvoiceSettings param.Field[CustomerCreditTopUpNewByExternalIDParamsInvoiceSettings] `json:"invoice_settings" api:"required"`
	// How much, in the customer's currency, to charge for each unit.
	PerUnitCostBasis param.Field[string] `json:"per_unit_cost_basis" api:"required"`
	// The threshold at which to trigger the top-up. If the balance is at or below this
	// threshold, the top-up will be triggered.
