...
func TestMetricNewWithOptionalParams(t *testing.T) {
...
func TestMetricUpdateWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestMetricListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Metrics.List(context.TODO(), orb.MetricListParams{
