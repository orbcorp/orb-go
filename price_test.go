...
func TestPriceNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Prices.New(context.TODO(), orb.PriceNewParamsNewFloatingUnitPrice{
		...
		ConversionRateConfig: orb.F[orb.PriceNewParamsNewFloatingUnitPriceConversionRateConfigUnion](orb.PriceNewParamsNewFloatingUnitPriceConversionRateConfigUnitConversionRateConfig{
			ConversionRateType: orb.F(orb.PriceNewParamsNewFloatingUnitPriceConversionRateConfigUnitConversionRateConfigConversionRateTypeUnit),
			UnitConfig: orb.F(orb.PriceNewParamsNewFloatingUnitPriceConversionRateConfigUnitConversionRateConfigUnitConfig{
				UnitAmount: orb.F("unit_amount"),
			}),
		}),
	...
	_, err := client.Prices.EvaluateMultiple(context.TODO(), orb.PriceEvaluateMultipleParams{
		...
		PriceEvaluations: orb.F([]orb.PriceEvaluateMultipleParamsPriceEvaluation{{
			...
			Price: orb.F[orb.PriceEvaluateMultipleParamsPriceEvaluationsPriceUnion](shared.NewFloatingUnitPriceParam{
				...
				ConversionRate: orb.F(0.000000),
				ConversionRateConfig: orb.F[shared.NewFloatingUnitPriceConversionRateConfigUnionParam](shared.NewFloatingUnitPriceConversionRateConfigUnitConversionRateConfigParam{
					ConversionRateType: orb.F(shared.NewFloatingUnitPriceConversionRateConfigUnitConversionRateConfigConversionRateTypeUnit),
					UnitConfig: orb.F(shared.NewFloatingUnitPriceConversionRateConfigUnitConversionRateConfigUnitConfigParam{
						UnitAmount: orb.F("unit_amount"),
					}),
				}),
				DimensionalPriceConfiguration: orb.F(shared.NewDimensionalPriceConfigurationParam{
