...
// Union satisfied by [SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCost]
// or [SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostV2].
type SubscriptionFetchCostsResponseDataPerPriceCost interface {
	implementsSubscriptionFetchCostsResponseDataPerPriceCost()
}

func init() {
	apijson.RegisterUnion(reflect.TypeOf((*SubscriptionFetchCostsResponseDataPerPriceCost)(nil)).Elem(), "")
}

type SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCost struct {
	// The Price resource represents a price that can be billed on a subscription,
	// resulting in a charge on an invoice in the form of an invoice line item. Prices
	// take a quantity and determine an amount to bill.
	//
	...
	PriceGroups []SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostPriceGroup `json:"price_groups,nullable"`
	// The price's quantity for the timeframe
	Quantity float64                                                         `json:"quantity,nullable"`
	JSON     subscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostJSON `json:"-"`
}

// subscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostJSON contains the
// JSON metadata for the struct
// [SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCost]
type subscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostJSON struct {
	Price       apijson.Field
	Subtotal    apijson.Field
	Total       apijson.Field
...
func (r *SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCost) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCost) implementsSubscriptionFetchCostsResponseDataPerPriceCost() {
}

type SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostPriceGroup struct {
	...
	Total string                                                                    `json:"total,required"`
	JSON  subscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostPriceGroupJSON `json:"-"`
}

// subscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostPriceGroupJSON
// contains the JSON metadata for the struct
// [SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostPriceGroup]
type subscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostPriceGroupJSON struct {
...
func (r *SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostPriceGroup) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

type SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostV2 struct {
	// The Price resource represents a price that can be billed on a subscription,
	// resulting in a charge on an invoice in the form of an invoice line item. Prices
	// take a quantity and determine an amount to bill.
	//
	...
	// If a `group_by` attribute is passed in, array of costs per `grouping_key`,
	// `grouping_value` or `secondary_grouping_key`, `secondary_grouping_value`.
	PriceGroups []SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostV2PriceGroup `json:"price_groups,nullable"`
	// The price's quantity for the timeframe
	Quantity float64                                                           `json:"quantity,nullable"`
	JSON     subscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostV2JSON `json:"-"`
}

// subscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostV2JSON contains the
// JSON metadata for the struct
// [SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostV2]
type subscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostV2JSON struct {
	Price       apijson.Field
	Subtotal    apijson.Field
	Total       apijson.Field
	PriceGroups apijson.Field
...
func (r *SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostV2) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostV2) implementsSubscriptionFetchCostsResponseDataPerPriceCost() {
}

type SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostV2PriceGroup struct {
	// Grouping key to break down a single price's costs
	GroupingKey   string `json:"grouping_key,required"`
	GroupingValue string `json:"grouping_value,required,nullable"`
	// If the price is a matrix price, this is the second dimension key
	...
	// for any minimums or discounts.
	Total string                                                                      `json:"total,required"`
	JSON  subscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostV2PriceGroupJSON `json:"-"`
}

// subscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostV2PriceGroupJSON
// contains the JSON metadata for the struct
// [SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostV2PriceGroup]
type subscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostV2PriceGroupJSON struct {
	GroupingKey            apijson.Field
	GroupingValue          apijson.Field
	SecondaryGroupingKey   apijson.Field
	SecondaryGroupingValue apijson.Field
...
func (r *SubscriptionFetchCostsResponseDataPerPriceCostsPerPriceCostV2PriceGroup) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}
