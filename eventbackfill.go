...
func (r *EventBackfillService) New(ctx context.Context, body EventBackfillNewParams, opts ...option.RequestOption) (res *shared.BackfillModel, err error) {
...
func (r *EventBackfillService) List(ctx context.Context, query EventBackfillListParams, opts ...option.RequestOption) (res *pagination.Page[shared.BackfillModel], err error) {
...
// retrieve the next page of results if they exist. More information about
// pagination can be found in the [Pagination-metadata schema](pagination).
func (r *EventBackfillService) ListAutoPaging(ctx context.Context, query EventBackfillListParams, opts ...option.RequestOption) *pagination.PageAutoPager[shared.BackfillModel] {
